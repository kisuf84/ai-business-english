 ...
 * offline search-index generator (scripts/buildSyntaxFlowSearchIndex.ts) and
 * the runtime search route, so indexed text and incoming queries are folded
 * identically — that symmetry is what makes "Él desarrolló" and
